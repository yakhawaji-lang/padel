-- ============================================================================
-- Booking System V2 - Migrations for u502561206_padel_db
-- Soft Lock, Status Workflow, Split Booking, Refunds
-- ============================================================================

-- 1. booking_slot_locks (Soft Lock at DB level)
...
-- 2. club_settings - new columns (run separately if column exists)
...
-- 4. booking_payment_shares - new columns
