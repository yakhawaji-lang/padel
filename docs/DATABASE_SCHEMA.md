...
## توافق القاعدة المحلية (XAMPP) مع u502561206_padel_db

لتهيئة القاعدة المحلية **padel_db** (XAMPP) بنفس هيكل **u502561206_padel_db**، نفّذ ملف SQL من phpMyAdmin:

- **الملف:** `server/db/LOCAL_PADEL_DB_FULL_SCHEMA.sql`
- **الرابط:** اختر `padel_db` ثم تبويب SQL أو استيراد.  
راجع `docs/LOCAL_XAMPP_SETUP.md` للتفاصيل.
