...
> **المرفوعات الحية:** الصور المرفوعة من لوحة التحكم تُحفظ الآن في **`uploads/`** (انظر `uploads/README.md` في جذر المستودع). يبقى مجلد `Gallery/` للقوالب المرجعية وللقراءة الاحتياطية للملفات القديمة عبر `/api/gallery/serve`.
