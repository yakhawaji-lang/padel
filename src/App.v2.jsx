...
function App() {
  const [activeTab, setActiveTab] = useState('king') // 'king', 'social', 'members', or 'oldTournaments'
        ...
        <div className="header-content">
          ...
          <div className="header-center">
            <div className="header-title">
              {activeTab === 'king' ? t.kingOfCourt : activeTab === 'social' ? t.socialTournament : activeTab === 'members' ? t.members : t.oldTournaments}
            </div>
          </div>
