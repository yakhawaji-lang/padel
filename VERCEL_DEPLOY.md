...
أضف في متغيرات البيئة (Vercel أو Hostinger):
...
| المتغير | القيمة | ملاحظة |
|---------|--------|--------|
| **WHATSAPP_VERIFY_TOKEN** | نص سري (مثل: `playtix_whatsapp_verify`) | للتطابق مع Meta |
| **WHATSAPP_ACCESS_TOKEN** | رمز الوصول من Meta | WhatsApp → API Setup |
| **WHATSAPP_PHONE_NUMBER_ID** | معرف رقم الهاتف | من Meta API Setup |
